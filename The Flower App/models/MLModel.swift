...
//
//                                    let newFlower = FlowerData(imageBlob: cameraString, data: "", entryId: newEntryId, date: newEntryDate, flowerId: flower.flowerId)
//
//                                    Task {
...
//            do {
//                let model = try VNCoreMLModel(for: plant2110().model)
